      ...
      <div className='text-[8px] sm:text-[10px] md:text-[15px] main max-w-[700px] p-2 md:p-6 my-10'>
        ...
        <div className="p-[14px] md:p-5 bg-[#182655] w-full flex justify-center shadow-2xl">
          <table className=" bg-white w-full ">
            <tr>
              <th className="bg-[#182655] text-white text-left md:px-2 w-5">RANK</th>
              <th className="bg-[#182655] text-white text-left px-1 md:px-2 w-7">
                +/-
              </th>
              <th className="bg-[#182655] text-white text-left"></th>
              <th className="bg-[#182655] text-white text-left px-1 md:px-2 sm:w-80 ">NAME</th>
            ...
            {songsList.map((song) => (
              <tr className="even:bg-white odd:bg-gray-100">
                ...
                <td className={song.weeks_on_chart<200?"px-2": "bg-yellow-100 px-2"}>{song.weeks_on_chart}</td>
              </tr>
            ))}
          </table>
        </div>
