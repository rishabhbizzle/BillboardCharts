    ...
    <div className="w-full flex flex-col justify-center items-center bg-slate-200">
      <div className="text-[8px] sm:text-[10px] md:text-[15px] box max-w-[700px] p-2 md:p-6 my-10">
        <div className="head w-full shadow-2xl">
          <img src={Hot} className="items-center" alt="" />
        </div>
        {/* <div className="hot">
        <img src={Hot} alt="" />
        </div> */}
        <div className="p-[14px] md:p-5 bg-black w-full flex justify-center shadow-2xl">
          <table className=" bg-white w-full ">
            <tr>
              ...
              <th className="bg-black text-white text-left px-1 md:px-2 ">SONG</th>
              <th className="bg-black text-white text-left px-1 md:px-2">ARTIST</th>
              <th className="bg-black text-white text-left px-1 md:px-2">
                PEAK
              </th>
              <th className="bg-black text-white text-left px-1">
                W.O.C
              </th>
            </tr>
            ...
            {songsList.map((song) => (
              <tr className="even:bg-white odd:bg-gray-100">
                ...
                <td className={song.weeks_on_chart<40?"px-2": "bg-yellow-100 px-2"}>{song.weeks_on_chart}</td>
              </tr>
            ))}
          </table>
        </div>
        ...
        <button disabled={endList>=100} onClick={nextList} className={endList>=100? "bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded-l opacity-50 cursor-not-allowed": "bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded-l"}>
          Next
        </button>
      </div>
      </div>
